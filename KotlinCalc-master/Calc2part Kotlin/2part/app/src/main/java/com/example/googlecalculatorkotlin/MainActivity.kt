...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button0 = findViewById<Button>(R.id.bt_0)
        button1 = findViewById<Button>(R.id.bt_1)
        button2 = findViewById<Button>(R.id.bt_2)
        button3 = findViewById<Button>(R.id.bt_3)
        button4 = findViewById<Button>(R.id.bt_4)
        button5 = findViewById<Button>(R.id.bt_5)
        button6 = findViewById<Button>(R.id.bt_6)
        button7 = findViewById<Button>(R.id.bt_7)
        button8 = findViewById<Button>(R.id.bt_8)
        button9 = findViewById<Button>(R.id.bt_9)
        buttonAdd = findViewById<Button>(R.id.bt_plus)
        buttonSub = findViewById<Button>(R.id.bt_minus)
        buttonmul = findViewById<Button>(R.id.bt_mult)
        buttonDiv = findViewById<Button>(R.id.bt_div)
        buttonEqual = findViewById<Button>(R.id.bt_eq)
        buttonDel = findViewById<Button>(R.id.bt_cancel)
        buttonClr = findViewById<Button>(R.id.bt_AC)
        buttonPercent = findViewById<Button>(R.id.percent)
        buttonDegree = findViewById<Button>(R.id.bt_sqr)
        buttonSqrt = findViewById<Button>(R.id.bt_sqrt)
        buttonDot = findViewById<Button>(R.id.bt_point)
        edt1 = findViewById<TextView>(R.id.text)

        buttonSin = findViewById<Button>(R.id.bt_sin)
        buttonCos = findViewById<Button>(R.id.bt_cos)
        buttonTan = findViewById<Button>(R.id.bt_tg)

        buttonFactorial = findViewById<Button>(R.id.bt_fac)
        buttonSquare = findViewById<Button>(R.id.bt_squareNM)
        buttonLn = findViewById<Button>(R.id.bt_ln)
        buttonLog = findViewById<Button>(R.id.bt_log)
